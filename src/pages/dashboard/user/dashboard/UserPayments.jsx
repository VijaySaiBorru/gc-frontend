                        ...
                        <li key={index}>
                            ...
                            <div className='flex md:flex-row items-center space-x-2'>
                                ...
                                <p className='text-gray-600'>
                                    ...
                                    ${item?.status === 'completed' ? 'bg-green-100 text-green-700': item?.status==='shipped' ?'bg-blue-200 text-blue-700':item?.status==='processing'?'bg-yellow-100 text-yellow-700':'bg-red-200 text-red-700'}`}>
                                        {item?.status}</span>
                                </p>
                            </div>
                            <hr className='my-2'/>
